    ...
    <nav className="top-0 left-0 z-50 bg-white shadow-lg mt-18 w-full">
      <div className="flex justify-between items-center mx-auto px-4 py-3 container">
        ...
        <div className="md:flex items-center space-x-8 hidden">
          ...
          <a
            href="/ai-feedback"
            className="bg-gradient-to-r from-blue-600 hover:from-blue-700 to-purple-600 hover:to-purple-700 p-2 rounded-lg font-medium text-white transition-all"
          >
            AI Mentor 
          </a>
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && (
          <div className="top-24 left-0 z-10 absolute md:hidden bg-white shadow-lg w-4/5 sm:w-1/2 h-[60vh]">
